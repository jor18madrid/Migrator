    ...
    public class SAS_MACRO
    {
        ...
        private List<SAS_MACRO_DTO> source_macros()
        {
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                DESC = "DESC",
                ORIGEN = "ORCL",
                STATEMENT = "alter table MDSAS.SAS_ACCIONES disable all triggers; \n" +
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                DESC = "DESC",
                ORIGEN = "ORCL",
                STATEMENT = "alter table MDSAS.SAS_ACCIONES enable all triggers; \n" +
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT =
                           "delete mdsas.sas_perfil_flujo_ope where id_operacion in (select id_operacion from mdsas.sas_flujos_operacion where id_flujo in (select id_flujo from mdsas.sas_flujos where id_sistema = '{||vl_sistema||}')); \n" +
                           "delete mdsas.sas_perfil_menu where id_menu in (select id_menu from mdsas.sas_menus where id_sistema = '{||vl_sistema||}'); \n" +
                           "delete mdsas.sas_flujos_ope_acciones where id_accion in (select id_accion from mdsas.sas_acciones where id_sistema = '{||vl_sistema||}'); \n" +
                           "delete mdsas.sas_flujos_ope_acciones where id_operacion in (select id_operacion from mdsas.sas_flujos_operacion where id_flujo in (select id_flujo from mdsas.sas_flujos where id_sistema = '{||vl_sistema||}')); \n" +
                           "delete mdsas.sas_flujos_ope_grupo where id_operacion in (select id_operacion from mdsas.sas_flujos_operacion where id_flujo in (select id_flujo from mdsas.sas_flujos where id_sistema = '{||vl_sistema||}')); \n" +
                           "delete mdsas.sas_flujos_operacion where id_flujo in (select id_flujo from mdsas.sas_flujos where id_sistema = '{||vl_sistema||}'); \n" +
                           "delete mdsas.sas_acciones where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_perfiles where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_menus where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_flujos where id_sistema = '{||vl_sistema||}';\n" +
                           "delete mdsas.sas_tablas_filtros where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_tablas_columnas where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_tablas where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_diccionario_operadores where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_diccionario_filtros where id_sistema = '{||vl_sistema||}'; \n" +
                           "delete mdsas.sas_diccionario_etapas where id_sistema = '{||vl_sistema||}'; \n",
                PRIORIDAD = 3,
                TIPEM = -1
            });
...
alter table MDSAS.SAS_ACCESOS_PERFILES enable constraint ACCPER_SASUSR_FK;"+"\n",                              
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = "insert into mdsas.sas_acciones (\n" +
                            ...
                            " values( \n " +
                            "'{||id_accion||}', '{||accion||}', '{||nombre_accion||}', '{||desc_accion||}', '{||id_sistema||}', '{||aplicacion||}', '{||capa||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = "insert into mdsas.sas_perfiles (\n"+ 
                            ...
                            "  values (\n "+
                            "  '{||id_perfil||}', '{||id_sistema||}', '{||nombre_perfil||}', '{||desc_perfil||}', '{||tipo_perfil||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = "insert into mdsas.sas_menus (\n"+
                            ...
                            "values (\n " +
                            " '{||id_menu||}', '{||id_sistema||}', '{||nombre_menu||}', '{||id_menu_padre||}', '{||orden||}','{||jerarquia||}', '{||metodo||}', '{||desc_menu||}', '{||tipo_menu||}', '{||ico_menu||}', '{||tooltip||}','{||vigente||}', '{||habilitado||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = "insert into mdsas.sas_flujos (\n "+
                            "id_flujo, id_sistema, flujo, area, aplicacion, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+
                            ") values (\n"+
                            "'{||id_flujo||}', '{||id_sistema||}', '{||flujo||}', '{||area||}', '{||aplicacion||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = "insert into mdsas.sas_tablas (\n"+
                            ...
                            ") values ( \n"+
                            "'{||id_sistema||}', '{||id_tabla||}', '{||nombre_tabla||}', '{||alias_tabla||}', '{||desc_tabla||}', '{||owner||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_tablas_columnas ( \n "+
                            ...
                            ") values ( \n"+
                            "'{||id_sistema||}','{||id_tabla||}','{||id_columna||}','{||nombre_columna||}','{||comentario||}','{||vigente||}','{||api_estado||}','{||api_transaccion||}','{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = "insert into mdsas.sas_tablas_filtros ( \n"+
                            "id_sistema, id_columna, id_filtro, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+ 
                            " ) values ( \n"+
                            " '{||id_sistema||}', '{||id_columna||}', '{||id_filtro||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_diccionario_operadores ( \n"+
                            ...
                            ") values ( \n"+
                            "'{||id_operador||}', '{||id_sistema||}', '{||nombre_operador||}', '{||simbolo||}', '{||descripcion||}', '{||statement||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}', to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.') , null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_diccionario_filtros ( \n" +
                            " id_filtro, id_sistema, nombre_filtro, desc_filtro, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n" +
                            " ) values ( \n"+
                            " '{||id_filtro||}', '{||id_sistema||}', '{||nombre_filtro||}', '{||desc_filtro||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_diccionario_etapas ( \n"+
                            " id_etapa, id_sistema, nombre_etapa, desc_etapa, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+
                            ") values ( \n"+
                            "'{||id_etapa||}', '{||id_sistema||}', '{||nombre_etapa||}', '{||desc_etapa||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_perfil_menu ( \n"+
                            "id_perfil, id_menu, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+
                            " ) values ( \n"+
                            "'{||id_perfil||}', '{||id_menu||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}', to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate);",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_flujos_operacion ( \n"+
                            "id_flujo, id_operacion, desc_operacion, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+
                            ") values ( \n"+
                            " '{||id_flujo||}', '{||id_operacion||}', '{||desc_operacion||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}', to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_flujos_ope_acciones (\n"+
                            "id_accion, id_operacion, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+
                            " ) values ( \n"+
                            "'{||id_accion||}', '{||id_operacion||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,                
            ...
            macros.Add(new SAS_MACRO_DTO()
            {
                ...
                ORIGEN = "ORCL",
                STATEMENT = " insert into mdsas.sas_perfil_flujo_ope ( \n"+
                            "id_perfil, id_operacion, vigente, api_estado, api_transaccion, usu_cre, fec_cre, usu_mod, fec_mod \n"+
                            ") values (\n"+
                            "'{||id_perfil||}', '{||id_operacion||}', '{||vigente||}', '{||api_estado||}', '{||api_transaccion||}', '{||usu_cre||}',to_date(replace('{||fec_cre||}','.',''),'DD/MM/YYYY HH:MI:SS P.M.'), null, sysdate); ",
                //ORDEN = 1,
                PRIORIDAD = 4,
