...
namespace SAS.TOOLS.DA
{
    ...
    public partial class API_ESTADOS
    {
        public API_ESTADOS()
        {
            this.API_TRANSICIONES = new HashSet<API_TRANSICIONES>();
            this.API_TRANSICIONES1 = new HashSet<API_TRANSICIONES>();
        }
        ...
        public virtual ICollection<API_TRANSICIONES> API_TRANSICIONES1 { get; set; }
    }
}
